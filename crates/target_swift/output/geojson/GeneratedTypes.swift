...
public typealias Root = GeojsonObject
 ...
 */
public typealias BoundingBox = [Double]
 ...
 */
public enum GeojsonObject: Codable {
...
public struct GeojsonObjectFeature: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard discriminator == "Feature" else {
        ...
        self.id = try container.decodeIfPresent(AnyCodable.self, forKey: .id)
    }
...
public struct GeojsonObjectFeatureCollection: Codable {
    public let features: [GeojsonObject]
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "FeatureCollection" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectGeometryCollection: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "GeometryCollection" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
        ...
        self.bbox = try container.decodeIfPresent(BoundingBox.self, forKey: .bbox)
    }
...
public struct GeojsonObjectLineString: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "LineString" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectMultiLineString: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "MultiLineString" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectMultiPoint: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "MultiPoint" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectMultiPolygon: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "MultiPolygon" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectPoint: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "Point" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
...
public struct GeojsonObjectPolygon: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let discriminator = try container.decode(String.self, forKey: .type)
        guard discriminator == "Polygon" else {
            throw DecodingError.dataCorrupted(DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Invalid discriminator value: \(discriminator)"
            ))
 ...
 * within the surface.
 */
public typealias LinearRing = [Position]
